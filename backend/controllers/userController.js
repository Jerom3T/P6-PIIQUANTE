...
// Importation du modèle User défini pour MongoDB/Mongoose

const bcrypt = require('bcrypt');
// Importation du package Bcrypt pour le hashage des mots de passe

const jwt = require('jsonwebtoken');
// Importation du package JsonWebToken pour la création de jetons d'authentification
